var cakes =[{weight:7,  value:160},
            {weight:3, value:90},
            {weight:2, value:15}];

var weightCapacity=20;

var result=maxDuffelBagValue(cakes, weightCapacity);
...
function maxDuffelBagValue(cakeTypes, weightCapacity) {
    ...
    for (var currentCapacity = 0; currentCapacity <= weightCapacity; currentCapacity++) {
       ...
       // console.log(currentCapacity+' <='+ weightCapacity);
        ...
        for (var j = 0; j < cakeTypes.length; j++) {
            ...
            console.log('cake weight: '+cakeTypes[j].weight);
        ...
        console.log(' maxValuesAtCapacities['+currentCapacity+']= '+ maxValuesAtCapacities[currentCapacity]);
    }
